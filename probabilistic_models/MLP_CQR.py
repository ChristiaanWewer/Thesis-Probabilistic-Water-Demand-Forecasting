...
for ii, dma in enumerate(DMAs):
    ...
    CQR_preds = cpfc.predict_CQR(
        ...
        update_nonconformity_scores=data_test_dma_y,
        batch_size=256
    )
    ...
    # get scores for prediction intervals test data
    ...
    test_lowest_MAE = compute_lowest_AE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt)
    test_lowest_MAPE = compute_lowest_APE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt)
    test_lowest_RMAE = compute_lowest_RAE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt, y_naive=naive_test[ii])
    test_highest_MAE = compute_highest_AE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt)
    test_highest_MAPE = compute_highest_APE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt)
    test_highest_RMAE = compute_highest_RAE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt, y_naive=naive_test[ii])
    test_median_MAE = compute_median_AE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt)
    test_median_MAPE = compute_median_APE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt)
    test_median_RMAE = compute_median_RAE(data_test_dma_y_unscaled, CQR_preds_unscaled_pt, y_naive=naive_test[ii])
    ...
    # get scores for prediction intervals validation data
    ...
    # get scores for point predictions validation data
    ...
    dict_result_dma_test = {
        ...
        'lowest_AE':       test_lowest_MAE,
        'lowest_APE':      test_lowest_MAPE,
        'lowest_RAE':      test_lowest_RMAE,
        'highest_AE':      test_highest_MAE,
        'highest_APE':     test_highest_MAPE,
        'highest_RAE':     test_highest_RMAE,
        'median_AE':       test_median_MAE,
        'median_APE':      test_median_MAPE,
        'median_RAE':      test_median_RMAE,
    }
